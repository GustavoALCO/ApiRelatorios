...
public class TabelasFiscalizacao : ITabelasFiscalizacao
{
    private readonly ILogger<TabelasFiscalizacao> _logger;

    public TabelasFiscalizacao(
        ILogger<TabelasFiscalizacao> logger)
    {
        _logger = logger;
    }
        ...
        IEnumerable<DadosRelatorioDTO> dto)
    {
            ...
            true))
        {
            ...
            var bodyRelatorio =
                BodyRelatorioFiscalizacao.Criar(ctx, dadosAgrupados);
